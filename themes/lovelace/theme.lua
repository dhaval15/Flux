...
local b_color = "#DDDD11"

-- Get colors from .Xresources and set fallback colors
theme.xbackground = "#FFFFFF"--xrdb.background or "#1D1F28"
...
theme.xcolor7 = "#BBBBBB"--xrdb.color7 or "#FDFDFD"
...
theme.border_color = b_color
theme.border_normal = b_color
theme.border_focus  = b_color
-- Rounded corners
...
theme.sidebar_bg = "#FFFFFF" --theme.xbackground
theme.sidebar_bg_alt = "#FFFFFF"--theme.xcolor0
